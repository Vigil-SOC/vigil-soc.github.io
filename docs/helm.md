...
{% raw %}
Vigil ships with a Helm chart under [`infra/helm/vigil/`](https://github.com/Vigil-SOC/vigil/blob/main/infra/helm/vigil) that
...
See [HELM-SECRETS.md](/docs/helm-secrets/) for end-to-end workflows covering
