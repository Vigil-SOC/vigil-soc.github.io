...
compatible. See [`RELEASING.md`](/docs/releasing/) for the full release process.
...
release. See [`RELEASING.md`](/docs/releasing/) for the rationale and the
...
[`RELEASING.md`](/docs/releasing/)). It is not strictly enforced at the
